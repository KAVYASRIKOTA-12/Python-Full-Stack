...
def virtual_assistant(data):
    ...
    if "email" in data:
        ...
        to = listen().lower()
        edict = {'kavya':'kavyasrikota989@gamil.com'} #give mail ids
        toaddr = edict[to]
        ...
        mail.starttls()
        #login
        mail.login('kavyasrikota989@gmail.com','wtxf ecwh gken qkqs')
        mail.sendmail('kavyasrikota989@gamil.com',toaddr,content)                
        mail.close()
        respond('Email Sent')
